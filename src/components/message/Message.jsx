    ...
    return (
          <section id='contact' className="contactForm">
               ...
               <form autoComplete='off' ref={form} onSubmit={handleSubmit} className="reveal_2 formContainer">
                   <input required className='input' type="text" name="name" placeholder='Votre nom...' value={formData.name} onChange={handleChange}/>
                   <input required className='input' type="email" name="email" placeholder='Votre Email...' value={formData.email} onChange={handleChange}/>
                   <textarea required name="message" id="" value={formData.message} onChange={handleChange} placeholder='Votre message...' cols="30" rows="5"></textarea>
